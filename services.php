...
<head>
    ...
    <meta name="description" content="8W社区公共服务页面 - 汇集Minecraft Java版服务器各类实用工具和资源链接，包括在线地图、官方QQ群、QQ频道等服务，为玩家提供便捷的一站式服务导航。">
    ...
    <meta property="og:url" content="https://8w.bgjq.top/services">
    ...
    <link rel="canonical" href="https://8w.bgjq.top/services">
    <title>公共服务 - 8W社区官方网站</title>
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "公共服务 - 8W社区",
      "description": "8W社区公共服务列表，提供各种服务的名称和网址。",
      "url": "https://8w.bgjq.top/services",
      "publisher": {
        "@type": "Organization",
        "name": "8W社区",
    ...
    <style>
        ...
        .service-item:hover {
            ...
            background-color: rgba(74, 125, 181, 0.05);
        }
    ...
    <nav>
        <div class="container">
            ...
            <ul class="nav-menu" id="navMenu">
                ...
                <li><a href="/services" class="nav-link active" data-i18n="public_services">公共服务</a></li>
    ...
    <main>
        <div class="container">
            <section class="section">
                <h2 class="section-title" data-i18n="public_services">公共服务</h2>
                
                <div class="nes-container with-title">
                    <h3 class="title" data-i18n="service_list">服务列表</h3>
                    <div class="service-list">
                        <?php
                        try {
                            if ($db) {
                                $services = getServicesData($db);
                                foreach ($services as $service) {
                                    echo renderService($service);
                                }
                                if (empty($services)) {
                                    echo "<div class=\"service-item nes-container\">
                                        <h4 class=\"service-name\" data-i18n=\"no_services\">暂无服务</h4>
                                        <p data-i18n=\"no_services_desc\">当前没有可用的服务。</p>
                                    </div>";
                                }
                            } else {
                            ...
                            echo "<div class=\"service-item nes-container\">
                                <h4 class=\"service-name\" data-i18n=\"service_load_error\">服务加载失败</h4>
                                <p data-i18n=\"service_load_error_desc\">服务数据加载失败，请稍后刷新页面。</p>
                            </div>";
                        }
                        ?>
                    </div>

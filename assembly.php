...
<head>
    ...
    <meta name="description" content="8W社区 - 社区大会，了解当前提案和世界公约">
    <meta name="keywords" content="邦国崛起,社区,社区大会,提案,公约,Minecraft,服务器">
    <meta name="author" content="8W社区">
    <meta name="robots" content="index, follow">
    <link rel="icon" href="/images/favicon.ico" type="image/x-icon">
    <link rel="shortcut icon" href="/images/favicon.ico" type="image/x-icon">
    <link rel="canonical" href="https://8w.bgjq.top/assembly">
    <title>社区大会 - 8W社区</title>
    <style>
        @font-face {
            font-family: 'ZPix';
    ...
    <nav>
        <div class="container">
            ...
            <ul class="nav-menu" id="navMenu">
                ...
                <li><a href="/assembly" class="nav-link active" data-i18n="un_assembly">社区大会</a></li>
    ...
    <main>
        <div class="container">
            <section class="section">
                <h2 class="section-title" data-i18n="un_assembly">社区大会</h2>
                <div class="nes-container with-title">
                    <h3 class="title" data-i18n="current_proposals">当前提案</h3>
                    <div class="proposal-list">
                        <?php
                        try {
                            if ($db) {
                                $proposals = getProposalsData($db);
                                $votingProposals = array_filter($proposals, function($p) {
                                    return $p['status'] === 'voting';
                                });
                                foreach ($votingProposals as $proposal) {
                                    echo renderProposal($proposal);
                                }
                                if (empty($votingProposals)) {
                                    echo "<div class=\"proposal-item nes-container\">
                                        <div class=\"proposal-header\">
                                            <span class=\"proposal-type nes-badge is-warning\" data-i18n=\"violation_other\">其他</span>
                                            <span class=\"proposal-status nes-badge\" data-i18n=\"no_proposals\">暂无</span>
                                        </div>
                                        <h4 class=\"proposal-title\" data-i18n=\"no_proposals\">暂无提案</h4>
                                        <p class=\"proposal-desc\" data-i18n=\"no_proposals_desc\">当前没有正在进行投票的提案。</p>
                                    </div>";
                                }
                            } else {
                            ...
                            echo "<div class=\"proposal-item nes-container\">
                                <div class=\"proposal-header\">
                                    <span class=\"proposal-type nes-badge is-warning\" data-i18n=\"violation_other\">其他</span>
                                    <span class=\"proposal-status nes-badge\" data-i18n=\"proposals_loading\">加载中</span>
                                </div>
                                <h4 class=\"proposal-title\" data-i18n=\"proposals_loading\">提案加载中</h4>
                                <p class=\"proposal-desc\" data-i18n=\"proposals_loading_desc\">提案数据正在加载，请稍后刷新页面。</p>
                            </div>";
                        }
                        ?>
                    </div>
                ...
                <div class="nes-container with-title">
                    <h3 class="title" data-i18n="world_conventions">世界公约</h3>
                    <div class="convention-list">
                        <?php
                        try {
                            if ($db) {
                                $conventions = getConventionsData($db);
                                foreach ($conventions as $convention) {
                                    echo renderConvention($convention);
                                }
                                if (empty($conventions)) {
                                    echo "<div class=\"convention-item nes-container\">
                                        <h4><i class=\"nes-icon is-small star\"></i> <span data-i18n=\"no_conventions\">暂无公约</span></h4>
                                        <p data-i18n=\"no_conventions_desc\">当前没有生效的世界公约。</p>
                                    </div>";
                                }
                            } else {
                                throw new Exception('数据库连接失败');
                            ...
                            echo "<div class=\"convention-item nes-container\">
                                <h4><i class=\"nes-icon is-small star\"></i> <span data-i18n=\"conventions_loading\">公约加载中</span></h4>
                                <p data-i18n=\"conventions_loading_desc\">公约数据正在加载，请稍后刷新页面。</p>
                            </div>";
                        }
                        ?>
                    </div>
